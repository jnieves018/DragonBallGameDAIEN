...
class Personaje(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if teclas[pygame.K_SPACE]:
            self.image = personaje = pygame.image.load(
                "assets/gokukamehameha.png").convert_alpha()
        elif kamehameha.rect.x > 860:
            self.image = personaje = pygame.image.load(
                "assets/goku.png").convert_alpha()

        if teclas[pygame.K_LEFT]:
            self.image = personaje = pygame.image.load(
                "assets/gokuleft.png").convert_alpha()
            if self.rect.x > 0:
                self.rect.x -= 10
        elif teclas[pygame.K_RIGHT]:
            self.image = personaje = pygame.image.load(
                "assets/gokuright.png").convert_alpha()
            if self.rect.x < 740:
                self.rect.x += 10

        if teclas[pygame.K_UP]:
            self.image = personaje = pygame.image.load(
                "assets/gokuup.png").convert_alpha()
            if self.rect.y > 32:
                self.rect.y -= 10
        elif teclas[pygame.K_DOWN]:
            if self.rect.y < 530:
                self.image = personaje = pygame.image.load(
                    "assets/gokudown.png").convert_alpha()
                self.rect.y += 10
...
class Kamehameha(pygame.sprite.Sprite):
    def __init__(self):
        self.image = kamehameha = pygame.image.load(
            "assets/kamehameha.gif").convert_alpha()
        self.rect = self.image.get_rect()
...
class Barravidagoku(pygame.sprite.Sprite):
    def __init__(self):
        self.image = barravidagoku = pygame.image.load(
            "assets/barravidagoku.png").convert_alpha()
        self.rect = self.image.get_rect()
...
class Minicell(pygame.sprite.Sprite):
    def __init__(self):
        self.image = minicell = pygame.image.load(
            "assets/minicell.png").convert_alpha()
        self.rect = self.image.get_rect()
...
class Disparo(pygame.sprite.Sprite):
    def __init__(self):
        self.image = barravidagoku = pygame.image.load(
            "assets/disparominicell.png").convert_alpha()
        self.rect = self.image.get_rect()
...
class Barravidaminicell(pygame.sprite.Sprite):
    def __init__(self):
        self.image = barravidaminicell = pygame.image.load(
            "assets/barravidaminicell.png").convert_alpha()
        self.rect = self.image.get_rect()
...
if __name__ == '__main__':
    ...
    fondo = pygame.image.load("assets/namek.jpg").convert()
    cuadrovidagoku = pygame.image.load(
        "assets/cuadrovidagoku.png").convert_alpha()
    cuadrovidaminicell = pygame.image.load(
        "assets/cuadrovidaminicell.png").convert_alpha()
    hasperdido = pygame.image.load("assets/Hasperdido.png").convert()
    hasganado = pygame.image.load("assets/Hasganado.png").convert()
